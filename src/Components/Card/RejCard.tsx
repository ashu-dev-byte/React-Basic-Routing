...
const RejCard: React.FC<Props> = (props) => {
  return (
    <div className="RejCard dimensions border-2 border-gray-300 rounded-lg m-8">
      <div className="flex">
        <img
      ...
      <div className="flex justify-start mt-6">
        <button className="flex fav-btn text-xl font-medium justify-center ml-8">
