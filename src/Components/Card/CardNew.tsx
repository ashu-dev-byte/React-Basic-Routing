...
const CardNew: React.FC<Props> = (props) => {
  return (
    <div className="CardNew dimensions border-2 border-gray-300 rounded-lg m-8">
      <div className="flex">
        <img
        ...
        <span className="relative new-tag font-medium w-16 h-8 flex justify-center items-center rounded-full">
          NEW
        </span>
      </div>
      <div className="ml-8">
